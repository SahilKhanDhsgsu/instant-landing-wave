...
const WhyChooseUs = () => {
  ...
  return (
    <section ref={sectionRef} className="py-20 bg-gradient-to-br from-orange-900/90 via-red-900/90 to-yellow-900/90 relative overflow-hidden">
      {/* Background Animation */}
      <div className="absolute inset-0">
        <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-orange-400/10 rounded-full animate-pulse" />
        <div className="absolute bottom-1/4 right-1/4 w-48 h-48 bg-red-400/10 rounded-full animate-pulse" style={{animationDelay: '1s'}} />
      </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          {features.map((feature, index) => (
            ...
            >
              ...
              <p className="text-lg text-orange-300 mb-4 font-semibold">{feature.subtitle}</p>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {stats.map((stat, index) => (
              ...
              >
                <div className="text-4xl lg:text-5xl font-bold text-transparent bg-gradient-to-r from-orange-300 to-yellow-300 bg-clip-text mb-2">
